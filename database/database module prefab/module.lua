...
module.config = {["iscool"] = {["label"] = "Is this a cool feature",["type"]="bool",["default"]=true}} --optional. Lets you add config settings which can be pulled by database.checkConfig("name").
