...
local function devMod(...)
  ...
  module.onTouch = function() --TODO: Prepare this for Module installation, user permissions, and more.
    ...
    local function moduleInstallation()
      ...
      local worked = true
      if worked then
        tempTable = {["success"]:true,["modules"]:[{["module"]:{["id"]:1,["status"]:"ACTIVE",["name"]:"Security",["shortDetails"]:"Secure your base with user access. Set up passes, assign users with access levels,  and more.",["description"]:"\u003Cp\u003EA fully fleshed out security system solution for Open Computers and Open Security.\u003C/p\u003E\n\u003Cp\u003EFeatures:\u003C/p\u003E\n\u003Cul\u003E\n\u003Cli\u003EMultiple door controlling with a single door computer\u003C/li\u003E\n\u003Cli\u003EPowerful passes system you set up yourself\u003C/li\u003E\n\u003Cli\u003ESecurity card blocking and disabling from the database\u003C/li\u003E\n\u003Cli\u003EEasy door creation using the Autoinstaller or \u003Cstrong\u003Edoor creation module (addon module)\u003C/strong\u003E\u003C/li\u003E\n\u003Cli\u003EEasy door editing, installing, and diagnostics with the diagnostic program\u003C/li\u003E\n\u003Cli\u003ELong-range data transfer with built-in support for servertine\u0027s range extender program\u003C/li\u003E\n\u003Cli\u003EModularity with a modified servertine API with support for changing user card data\u003C/li\u003E\n\u003Cli\u003EOptional modules you can play with that interface with your system \u003Cstrong\u003E(like Sectors module)\u003C/strong\u003E\u003C/li\u003E\n\u003Cli\u003EAnd much more!\u003C/li\u003E\n\u003C/ul\u003E\n\u003Cp\u003E\u003Ca href=\u0022https://github.com/cadergator10/opencomputer-security-system\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub home page for module\u003C/a\u003E\u003C/p\u003E\n\u003Cp\u003E\u003Ca title=\u0022Security module\u0027s specific files\u0022 href=\u0022https://github.com/cadergator10/opencomputer-security-system/tree/main/security\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub Security Folder\u003C/a\u003E\u003C/p\u003E",["concurrencyKey"]:"535689c1-ba69-4486-8f6d-10a84c65f056",["version"]:6,["optionals"]:"3,5,7",["devLink"]:"be997290-d1e8-49d3-95f0-cf4b575ee810"},["files"]:[{["key"]:3,["moduleId"]:1,["serverModule"]:true,["path"]:"Main.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/security/Server%20Module/security.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/security/Server%20Module/security.lua"},{["key"]:4,["moduleId"]:1,["serverModule"]:false,["path"]:"Main.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/security/Database%20Module/Main.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/security/Database%20Module/Main.lua"},{["key"]:21,["moduleId"]:1,["serverModule"]:false,["path"]:"user.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/security/Database%20Module/User.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/security/Database%20Module/User.lua"},{["key"]:22,["moduleId"]:1,["serverModule"]:false,["path"]:"pass.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/security/Database%20Module/Pass.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/security/Database%20Module/Pass.lua"}],["hasServer"]:true,["hasDatabase"]:true},{["module"]:{["id"]:3,["status"]:"ACTIVE",["name"]:"Sectors",["shortDetails"]:"Addon module for Security: Group doors and lock down or lock open with advanced modularity",["description"]:"\u003Cp\u003EGive doors groups which you can manage with the sector control computer. Lock doors open or lock them shut and let certain passes either bypass these or turn them off. You can also specify advanced pass checks used when a door is locked open or locked down to either allow them to disable a lockdown or let them enter the locked door anyway.\u0026nbsp;\u003C/p\u003E\n\u003Cp\u003E\u003Ca href=\u0022https://github.com/cadergator10/opencomputer-security-system\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub home page for module\u003C/a\u003E\u003C/p\u003E\n\u003Cp\u003E\u003Ca title=\u0022Sector module\u0027s specific files\u0022 href=\u0022https://github.com/cadergator10/opencomputer-security-system/tree/main/sectors\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub Sector Folder\u003C/a\u003E\u003C/p\u003E",["concurrencyKey"]:"6a100121-0879-4731-bada-35df57887505",["version"]:4,["requirements"]:"1",["optionals"]:"5",["devLink"]:"1fe124ba-cdf5-4643-986e-416c4915832b"},["files"]:[{["key"]:7,["moduleId"]:3,["serverModule"]:true,["path"]:"Main.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/sectors/Server%20Module/sectors.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/sectors/Server%20Module/sectors.lua"},{["key"]:8,["moduleId"]:3,["serverModule"]:false,["path"]:"Main.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/sectors/Database%20Module/Main.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/sectors/Database%20Module/Main.lua"}],["hasServer"]:true,["hasDatabase"]:true},{["module"]:{["id"]:5,["status"]:"ACTIVE",["name"]:"Door Setup",["shortDetails"]:"Addon module for Security: Begin setup of new doors on the database and finish on the computer after",["description"]:"\u003Cp\u003ESometimes it\u0027s tedious to go through the autoinstaller\u0027s prompts, so thats where this comes in. Rather than use pastebin run commands to run autoinstallers and such, instead just use this module! Setup some of the variables that you know what they should be right on the database and leave what you don\u0027t know for later. Then export the door settings to a drive on the computer and move over to the door you want and run the finish program. Now all you do is finish up the settings that you left and the settings you need to be there for and you\u0027re done! Lots of time saved!\u003C/p\u003E\n\u003Cp\u003E\u003Ca href=\u0022https://github.com/cadergator10/opencomputer-security-system\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub home page for module\u003C/a\u003E\u003C/p\u003E\n\u003Cp\u003E\u003Ca title=\u0022Door Setup module\u0027s specific files\u0022 href=\u0022https://github.com/cadergator10/opencomputer-security-system/tree/main/doorsetup\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub Door Setup Folder\u003C/a\u003E\u003C/p\u003E",["concurrencyKey"]:"1f7045e0-e799-4ab7-970d-194deb1b9a4a",["version"]:6,["requirements"]:"1",["optionals"]:"3",["devLink"]:"1d06d971-3e78-46bf-8e30-611b14c323e0"},["files"]:[{["key"]:11,["moduleId"]:5,["serverModule"]:false,["path"]:"Main.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/doorsetup/door.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/doorsetup/door.lua"},{["key"]:12,["moduleId"]:5,["serverModule"]:false,["path"]:"finish.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/doorsetup/finish.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/doorsetup/finish.lua"}],["hasServer"]:false,["hasDatabase"]:true},{["module"]:{["id"]:7,["status"]:"ACTIVE",["name"]:"Door Remote Control",["shortDetails"]:"Open and close doors from the security module using the database",["description"]:"\u003Cp\u003EThe remote control feature from the Diagnostics tablet in the Security module ported to the database screen. You can open and close doors simply from the database. Has the options to open for 5, 10, 30 seconds, any amount of seconds specified by the user, and to toggle the door open/close.\u003C/p\u003E\n\u003Cp\u003E\u003Ca href=\u0022https://github.com/cadergator10/opencomputer-security-system\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub home page for module\u003C/a\u003E\u003C/p\u003E\n\u003Cp\u003E\u003Ca title=\u0022Sector module\u0027s specific files\u0022 href=\u0022https://github.com/cadergator10/opencomputer-security-system/tree/main/remotecontrol\u0022 target=\u0022_blank\u0022 rel=\u0022noopener\u0022\u003EGithub Remote Control Folder\u003C/a\u003E\u003C/p\u003E",["concurrencyKey"]:"9f9b4f73-4912-4cb7-8a26-672eef99e304",["version"]:1,["requirements"]:"1",["devLink"]:"4c5e6661-3f28-45d0-b9c1-161f79618c9e"},["files"]:[{["key"]:24,["moduleId"]:7,["serverModule"]:false,["path"]:"Main.lua",["url"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/main/remotecontrol/main.lua",["devUrl"]:"https://raw.githubusercontent.com/cadergator10/opencomputer-security-system/newmodules/remotecontrol/main.lua"}],["hasServer"]:false,["hasDatabase"]:true}]}
        moduleTable = {}
        --tempTable = JSON.decode(tempTable).modules
        moduleTable = tempTable.modules
        hash = {}
        bothArray = {}
...
local function finishSetup()
  ...
  if updates then
    ...
    updates = {["success"]:true,["modules"]:[{["id"]:1,["version"]:6},{["id"]:3,["version"]:4},{["id"]:5,["version"]:6},{["id"]:7,["version"]:1}]}
