...
function module.getNotifications()
    local ev, e = compat.internet.request(mainPage,{["User-Agent"] = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.119 Safari/537.36"})
    if ev then
        ev = JSON.decode(ev)
